...
public class QuestionDialog extends JDialog {
	...
	private boolean checkData() {
		boolean ans = true;
		if (this.txtQuestion.getText() == null || this.txtQuestion.getText().trim().equals(""))
			ans = false;
		if (this.txtOption1.getText() == null || this.txtOption1.getText().trim().equals(""))
			ans = false;
		if (this.txtOption2.getText() == null || this.txtOption2.getText().trim().equals(""))
			ans = false;
		if (this.txtOption3.getText() == null || this.txtOption3.getText().trim().equals(""))
			ans = false;
		if (this.txtOption4.getText() == null || this.txtOption4.getText().trim().equals(""))
			ans = false;
		return ans;
	}
	...
	private boolean checkDuplicate() {
		boolean ans = true;
		if (this.txtOption1.getText().equals(this.txtOption2.getText()))
			ans = false;
		if (this.txtOption1.getText().equals(this.txtOption3.getText()))
			ans = false;
		if (this.txtOption1.getText().equals(this.txtOption4.getText()))
			ans = false;
		if (this.txtOption2.getText().equals(this.txtOption3.getText()))
			ans = false;
		if (this.txtOption2.getText().equals(this.txtOption4.getText()))
			ans = false;
		if (this.txtOption3.getText().equals(this.txtOption4.getText()))
			ans = false;
		return ans;
	}
